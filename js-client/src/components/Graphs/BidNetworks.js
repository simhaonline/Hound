...
function BidNetworks() {
    useEffect(() => {
        graphNetworks()
    },[])
    return (
        <div id='graph-networks-bid'></div>
    )
}

export default BidNetworks

const graphNetworks = () => {
    //create somewhere to put the force directed graph
    console.log('starting construction of d3 graph')
    var width = window.innerWidth,
    height = window.innerHeight
    var svg = d3.select("#graph-networks-bid").append("svg")
        .style("width",width)
        .style("height",height)
